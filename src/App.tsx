    ...
    function App() {
      ...
      const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
          ...
          if (reportData && infractions.length > 0) {
            // Save each infraction
            const infractionsToInsert = infractions.map(infraction => ({
            ...
            if (infractionsError) {
              console.error('Error saving infractions to Supabase:', infractionsError);
              setFormError('Erro ao salvar as infrações.');
              return;
            }
          }

          console.log('Data saved to Supabase:', reportData);
